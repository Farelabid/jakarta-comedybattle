    ...
    <section id="register" className="min-h-screen bg-[#0a0e27] relative overflow-hidden py-16 sm:py-24 md:py-32">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-r from-[#ff6b35] to-[#ffd93d] p-0.5 transform -rotate-1">
              <div className="bg-[#1a1438] px-6 py-4 flex items-start gap-4">
                <Lightbulb className="text-[#ffd93d] flex-shrink-0 mt-1" size={24} />
                <div>
                  <div className="text-[#ffd93d] font-display text-xl mb-2 tracking-wide">TEMA AUDISI</div>
                  <div className="text-white text-lg font-medium mb-2">"Betah Tinggal di Jakarta"</div>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Ceritakan pengalaman unik, lucu, atau menggelitik tentang kehidupan di Jakarta. 
                    Dari macet, banjir, sampai kuliner kaki lima—semua bisa jadi materi!
                  </p>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs mt-3">
                      Video harus sesuai tema: <span className="text-[#ffd93d]">"Betah Tinggal di Jakarta"</span>
                    </p>
              ...
              <div className="bg-[#1a1f3a] border-l-4 border-[#ff6b35] p-6 sm:p-8">
                ...
                <ul className="space-y-3 sm:space-y-4 text-gray-400 text-sm sm:text-base">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>Materi stand-up comedy original dengan tema <strong>"Betah Tinggal di Jakarta"</strong></span>
                  </li>
                  <li className="flex items-start gap-3">
