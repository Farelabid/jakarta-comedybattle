...
export function RegistrationForm() {
  ...
  return (
    <section id="register" className="min-h-screen bg-gradient-to-b from-[#1a1f3a] to-[#0a0e27] relative overflow-hidden py-32">
      {/* Section Number */}
      <motion.div
      ...
      >
        <div className="font-display text-[200px] text-[#ff6b35]/5 leading-none">04</div>
      </motion.div>
        ...
        >
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-xs tracking-[0.2em] text-gray-500 uppercase mb-3">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-6">
              {/* Requirements */}
              <div className="bg-[#1a1f3a] border-l-4 border-[#ff6b35] p-8">
                <h4 className="font-display text-2xl text-white mb-6 tracking-tight">
                  Persyaratan Video
                </h4>
              ...
              {/* Contact */}
              <div className="bg-[#ff6b35]/10 p-8">
